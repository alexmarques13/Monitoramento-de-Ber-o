...
#cap = cv2.VideoCapture(1) #0 pra webcam interna , 1 para externa
cap = PiCamera()

direct = '/home/pi/TCC/Time Lapse/images/timelapse/'
...
#timelapse_img_dir = '/home/pi/TCC/TimeLapse/images/timelapse/'
seconds_duration = 60
